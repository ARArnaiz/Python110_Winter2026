...
# Desc: Shows how to work with exceptions
# Change Log: (Who, When, What)
#  Alfredo Arnaiz, 20260213, Created Script
# ------------------------------------------------------------------------------------ #
import json

# Define the program's data
FILE_NAME: str = 'MyLabData_MIO.json'
MENU: str = '''
---- Student GPAs --------------------------------
...
while True:
    ...
    if menu_choice == "1":
        ...
        for student in students:
            ...
            print(message.format(student["FirstName"],
                                 student["LastName"],
                                 student["GPA"]))
        print("-"*50)
